...
func main() {
	...
	ovsCollectorID := flag.Int("ovs-collector-id", 1, "Set the ovs collector ID to use. Use alongside with -add-ovs-collector. Default to 1.")
	...
	err := reader.ReadSamples(ctx, *ovsCollectorID, groupID)
	if err != nil {
