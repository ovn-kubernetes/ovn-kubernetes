...
import (
	...
	egressqos "github.com/ovn-kubernetes/ovn-kubernetes/go-controller/pkg/crd/egressqos/v1/apis/informers/externalversions/egressqos"
...
type SharedInformerFactory interface {
	...
	K8s() egressqos.Interface
}

func (f *sharedInformerFactory) K8s() egressqos.Interface {
	return egressqos.New(f, f.namespace, f.tweakListOptions)
}
