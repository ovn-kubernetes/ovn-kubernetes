...
import (
	...
	networkqos "github.com/ovn-kubernetes/ovn-kubernetes/go-controller/pkg/crd/networkqos/v1alpha1/apis/informers/externalversions/networkqos"
)
...
type SharedInformerFactory interface {
	...
	K8s() networkqos.Interface
}

func (f *sharedInformerFactory) K8s() networkqos.Interface {
	return networkqos.New(f, f.namespace, f.tweakListOptions)
}
