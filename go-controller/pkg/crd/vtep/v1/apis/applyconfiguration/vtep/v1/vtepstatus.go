...
type VTEPStatusApplyConfiguration struct {
	...
	Allocations []VTEPAllocationApplyConfiguration   `json:"allocations,omitempty"`
}
...
func (b *VTEPStatusApplyConfiguration) WithAllocations(values ...*VTEPAllocationApplyConfiguration) *VTEPStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
