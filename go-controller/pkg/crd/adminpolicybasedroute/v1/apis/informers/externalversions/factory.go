...
import (
	...
	adminpolicybasedroute "github.com/ovn-kubernetes/ovn-kubernetes/go-controller/pkg/crd/adminpolicybasedroute/v1/apis/informers/externalversions/adminpolicybasedroute"
...
type SharedInformerFactory interface {
	...
	K8s() adminpolicybasedroute.Interface
}

func (f *sharedInformerFactory) K8s() adminpolicybasedroute.Interface {
	return adminpolicybasedroute.New(f, f.namespace, f.tweakListOptions)
}
