...
const (
	UplinkConditionDegraded = "Degraded"
)
...
const (
	...
	UplinkStateReasonMTUInvalid             = "MTUInvalid"
...
// Uplink defines a named cluster-wide external connectivity target. It
// represents a physical network path out of a node that OVN-Kubernetes can
// connect its logical topology to. Supported node config type: OVSBridge.
//
// +genclient
