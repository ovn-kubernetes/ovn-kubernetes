...
import (
	...
	clusternetworkconnect "github.com/ovn-kubernetes/ovn-kubernetes/go-controller/pkg/crd/clusternetworkconnect/v1/apis/informers/externalversions/clusternetworkconnect"
...
type SharedInformerFactory interface {
	...
	K8s() clusternetworkconnect.Interface
}

func (f *sharedInformerFactory) K8s() clusternetworkconnect.Interface {
	return clusternetworkconnect.New(f, f.namespace, f.tweakListOptions)
}
