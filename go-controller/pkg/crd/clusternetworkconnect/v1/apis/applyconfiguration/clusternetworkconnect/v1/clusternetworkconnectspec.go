...
type ClusterNetworkConnectSpecApplyConfiguration struct {
	...
	ConnectSubnets   *clusternetworkconnectv1.DualStackCIDRs `json:"connectSubnets,omitempty"`
	FeaturesEnabled  []clusternetworkconnectv1.FeatureType   `json:"featuresEnabled,omitempty"`
}
...
func (b *ClusterNetworkConnectSpecApplyConfiguration) WithConnectSubnets(value clusternetworkconnectv1.DualStackCIDRs) *ClusterNetworkConnectSpecApplyConfiguration {
...
func (b *ClusterNetworkConnectSpecApplyConfiguration) WithFeaturesEnabled(values ...clusternetworkconnectv1.FeatureType) *ClusterNetworkConnectSpecApplyConfiguration {
	for i := range values {
