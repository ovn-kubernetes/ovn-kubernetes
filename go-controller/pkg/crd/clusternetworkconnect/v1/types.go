...
type ConnectSubnet struct {
	...
	// Example: cidr= "192.168.0.0/16", networkPrefix= 24 means that you can connect 256 Layer3 networks
	// if the cluster has 128 nodes and 0 layer2 networks OR 255 Layer3 networks and 128 Layer2 networks
	// if the cluster has 128 nodes.
	//
