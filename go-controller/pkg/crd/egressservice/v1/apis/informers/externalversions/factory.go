...
import (
	...
	egressservice "github.com/ovn-kubernetes/ovn-kubernetes/go-controller/pkg/crd/egressservice/v1/apis/informers/externalversions/egressservice"
...
type SharedInformerFactory interface {
	...
	K8s() egressservice.Interface
}

func (f *sharedInformerFactory) K8s() egressservice.Interface {
	return egressservice.New(f, f.namespace, f.tweakListOptions)
}
