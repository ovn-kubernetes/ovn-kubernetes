...
import (
	...
	routeadvertisements "github.com/ovn-kubernetes/ovn-kubernetes/go-controller/pkg/crd/routeadvertisements/v1/apis/informers/externalversions/routeadvertisements"
)
...
type SharedInformerFactory interface {
	...
	K8s() routeadvertisements.Interface
}

func (f *sharedInformerFactory) K8s() routeadvertisements.Interface {
	return routeadvertisements.New(f, f.namespace, f.tweakListOptions)
}
