...
func schema_pkg_crd_observabilityconfig_v1alpha1_Filter(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Filter allows to apply ObservabilityConfig in a granular manner. Currently, it supports node and namespace based filtering. If both node and namespace filters are specifies, they are logically ANDed.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"nodeSelector": {
						SchemaProps: spec.SchemaProps{
