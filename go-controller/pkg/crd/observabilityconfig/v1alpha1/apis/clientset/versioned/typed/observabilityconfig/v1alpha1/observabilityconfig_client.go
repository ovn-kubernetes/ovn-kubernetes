...
func (c *K8sV1alpha1Client) ObservabilityConfigs(namespace string) ObservabilityConfigInterface {
	return newObservabilityConfigs(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) {
	gv := observabilityconfigv1alpha1.SchemeGroupVersion
