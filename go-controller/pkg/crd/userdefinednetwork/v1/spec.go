...
func (s *UserDefinedNetworkSpec) GetEVPNConfiguration() *EVPNConfiguration {
...
func (s *NetworkSpec) GetEVPNConfiguration() *EVPNConfiguration {
	return s.EVPNConfiguration
}
