...
import (
	...
	userdefinednetwork "github.com/ovn-kubernetes/ovn-kubernetes/go-controller/pkg/crd/userdefinednetwork/v1/apis/informers/externalversions/userdefinednetwork"
)
...
type SharedInformerFactory interface {
	...
	K8s() userdefinednetwork.Interface
}

func (f *sharedInformerFactory) K8s() userdefinednetwork.Interface {
	return userdefinednetwork.New(f, f.namespace, f.tweakListOptions)
}
