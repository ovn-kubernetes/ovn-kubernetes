...
type NetworkSpecApplyConfiguration struct {
	...
	EVPNConfiguration *EVPNConfigurationApplyConfiguration  `json:"evpnConfiguration,omitempty"`
}
...
func (b *NetworkSpecApplyConfiguration) WithEVPNConfiguration(value *EVPNConfigurationApplyConfiguration) *NetworkSpecApplyConfiguration {
