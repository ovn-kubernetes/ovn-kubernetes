...
// GenerateIPPair generates a pair of IPs from the base ip and the provided 'idx'
// For example, if the subnet was - 100.88.0.0/16 and the specified
// index is 1, it will return 100.88.0.2/31 and 100.88.0.3/31
func (ipGenerator *IPGenerator) GenerateIPPair(idx int) (*net.IPNet, *net.IPNet, error) {
	...
	return &net.IPNet{IP: firstIP, Mask: netMask}, &net.IPNet{IP: iputils.NextIP(firstIP), Mask: netMask}, nil
}
