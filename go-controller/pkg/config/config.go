...
type OvsPathConfig struct {
	...
	VswitchdPid string `gcfg:"vswitchd-pid"`
	// OvsDbServerPid is OVSDB server PID file path.
	OvsDbServerPid string `gcfg:"ovsdb-server-pid"`
}
...
var OvsPathsFlags = []cli.Flag{
	...
	&cli.StringFlag{
		Name:        "ovs-vswitchd-pid",
		Usage:       "OVS vSwitchd PID file path",
		Destination: &cliConfig.OvsPaths.VswitchdPid,
		Value:       OvsPaths.VswitchdPid,
	},
	&cli.StringFlag{
		Name:        "ovs-ovsdb-server-pid",
		Usage:       "OVSDB server PID file path",
		Destination: &cliConfig.OvsPaths.OvsDbServerPid,
		Value:       OvsPaths.OvsDbServerPid,
	},
}
