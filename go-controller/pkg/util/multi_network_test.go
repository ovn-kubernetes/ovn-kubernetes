...
func TestAreNetworksCompatible(t *testing.T) {
	tests := []struct {
		...
		{
			desc:                   "empty transport and default config should be compatible",
			aNetwork:               &userDefinedNetInfo{transport: ""},
			anotherNetwork:         &userDefinedNetInfo{transport: "default"},
			expectedResult:         true,
...
func TestEVPNNetworkCompatibility(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			aNetwork:               &userDefinedNetInfo{transport: "default"},
			anotherNetwork:         &userDefinedNetInfo{transport: "default"},
			expectedResult:         true,
			expectationDescription: "networks with no EVPN config should be compatible",
		},
