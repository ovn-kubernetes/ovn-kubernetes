...
func TestEVPNNetworkCompatibility(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			aNetwork:               &userDefinedNetInfo{transport: "evpn", evpnConfig: &ovncnitypes.EVPNConfig{VTEP: "vtep1"}},
			anotherNetwork:         &userDefinedNetInfo{transport: "evpn", evpnConfig: &ovncnitypes.EVPNConfig{VTEP: "vtep1"}},
			expectedResult:         true,
		...
		},
		{
			...
			aNetwork:               &userDefinedNetInfo{transport: "evpn", evpnConfig: &ovncnitypes.EVPNConfig{VTEP: "vtep1"}},
			anotherNetwork:         &userDefinedNetInfo{transport: "evpn", evpnConfig: &ovncnitypes.EVPNConfig{VTEP: "vtep2"}},
			expectedResult:         false,
