...
func SendUnsolicitedNeighborAdvertisement(interfaceName string, na NeighborAdvertisement) error {
	...
	// rfc4861 - for unsolicited advertisements use the all-nodes multicast address
	...
	// rfc4861 - hop Limit 255 as per RFC
	if err := c.WriteTo(una, &ipv6.ControlMessage{HopLimit: ndp.HopLimit}, allNodesMulticast); err != nil {
