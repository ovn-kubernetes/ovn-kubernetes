...
const (
	...
	// deprecated, only used for cleanup
	// TODO: do we need to remove this during upgrade?
...
// GetNodeIDWithError returns the node ID from the OvnNodeID annotation.
// Unlike GetNodeID, this function returns specific errors:
