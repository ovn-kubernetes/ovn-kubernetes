...
// SetNodeZone sets the node's zone annotation (OvnNodeZoneName) to the provided zoneName.
// It returns any error encountered while updating the annotation.
...
// GetNodeZone returns the node's OVN zone name from the OvnNodeZoneName annotation.
// If the annotation is not present, it returns the default zone name types.OvnDefaultZone.
