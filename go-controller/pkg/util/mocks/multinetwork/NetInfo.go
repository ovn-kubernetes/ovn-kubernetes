...
// GetNetworkEncapsulation provides a mock function with given fields:
func (_m *NetInfo) GetNetworkEncapsulation() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetNetworkEncapsulation")
	}
