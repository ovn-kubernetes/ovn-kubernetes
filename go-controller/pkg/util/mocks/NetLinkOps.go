...
// BridgeVlanAdd provides a mock function with given fields: link, vid, opts
func (_m *NetLinkOps) BridgeVlanAdd(link netlink.Link, vid uint16, opts util.BridgeVlanOptions) error {
	ret := _m.Called(link, vid, opts)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(netlink.Link, uint16, util.BridgeVlanOptions) error); ok {
		r0 = rf(link, vid, opts)
	} else {
		r0 = ret.Error(0)
	}
...
// BridgeVlanAddTunnelInfo provides a mock function with given fields: link, vid, vni, opts
func (_m *NetLinkOps) BridgeVlanAddTunnelInfo(link netlink.Link, vid uint16, vni uint32, opts util.BridgeVlanOptions) error {
	ret := _m.Called(link, vid, vni, opts)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(netlink.Link, uint16, uint32, util.BridgeVlanOptions) error); ok {
...
func (_m *NetLinkOps) BridgeVlanDel(link netlink.Link, vid uint16, opts util.BridgeVlanOptions) error {
	ret := _m.Called(link, vid, opts)
...
// BridgeVlanDelTunnelInfo provides a mock function with given fields: link, vid, vni, opts
func (_m *NetLinkOps) BridgeVlanDelTunnelInfo(link netlink.Link, vid uint16, vni uint32, opts util.BridgeVlanOptions) error {
	ret := _m.Called(link, vid, vni, opts)
