...
// BridgeVlanAdd provides a mock function with given fields: link, vid, options
func (_m *NetLinkOps) BridgeVlanAdd(link netlink.Link, vid uint16, options BridgeVlanOptions) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(netlink.Link, uint16, BridgeVlanOptions) error); ok {
		r0 = rf(link, vid, options)
	} else {
		r0 = ret.Error(0)
	}
...
// BridgeVlanAddTunnelInfo provides a mock function with given fields: link, vid, vni, options
func (_m *NetLinkOps) BridgeVlanAddTunnelInfo(link netlink.Link, vid uint16, vni uint32, options BridgeVlanOptions) error {
	ret := _m.Called(link, vid, vni, options)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(netlink.Link, uint16, uint32, BridgeVlanOptions) error); ok {
...
func (_m *NetLinkOps) BridgeVlanDel(link netlink.Link, vid uint16, options BridgeVlanOptions) error {
	ret := _m.Called(link, vid, options)
...
// BridgeVlanDelTunnelInfo provides a mock function with given fields: link, vid, vni, options
func (_m *NetLinkOps) BridgeVlanDelTunnelInfo(link netlink.Link, vid uint16, vni uint32, options BridgeVlanOptions) error {
	ret := _m.Called(link, vid, vni, options)
