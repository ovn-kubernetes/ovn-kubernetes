...
import (
	...
	types "github.com/ovn-kubernetes/ovn-kubernetes/go-controller/pkg/util/types"
)
...
func (_m *NetLinkOps) BridgeVlanAdd(link netlink.Link, vid uint16, options types.BridgeVlanOptions) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(netlink.Link, uint16, types.BridgeVlanOptions) error); ok {
...
func (_m *NetLinkOps) BridgeVlanAddTunnelInfo(link netlink.Link, vid uint16, vni uint32, options types.BridgeVlanOptions) error {
...
func (_m *NetLinkOps) BridgeVlanDelTunnelInfo(link netlink.Link, vid uint16, vni uint32, options types.BridgeVlanOptions) error {
	ret := _m.Called(link, vid, vni, options)
