...
func OvnNetworkSpanAttrs(netInfo NetInfo) []attribute.KeyValue {
	return []attribute.KeyValue{
		attribute.String(tracing.SpanAttrOvnK8sNetworkName, netInfo.GetNetworkName()),
		attribute.String(tracing.SpanAttrOvnK8sNetworkTopology, netInfo.TopologyType()),
		attribute.Bool(tracing.SpanAttrOvnK8sNetworkPrimary, netInfo.IsPrimaryNetwork()),
	}
}
