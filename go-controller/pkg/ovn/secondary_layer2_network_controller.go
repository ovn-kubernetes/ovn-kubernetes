	...
	if util.IsNetworkSegmentationSupportEnabled() && oc.IsPrimaryNetwork() {
		...
		if nSyncs.syncGw {
			...
			err := func() error {
				...
				err = oc.addOrUpdateUDNClusterSubnetEgressSNAT(gwConfig.hostSubnets, isUDNAdvertised)
				if err != nil {
					return err
				}
				if !isUDNAdvertised {
...
func (oc *SecondaryLayer2NetworkController) addOrUpdateUDNClusterSubnetEgressSNAT(localPodSubnets []*net.IPNet, isUDNAdvertised bool) error {
