...
func (oc *SecondaryLayer2NetworkController) addUpdateLocalNodeEvent(node *corev1.Node, nSyncs *nodeSyncs) error {
	...
	if util.IsNetworkSegmentationSupportEnabled() && oc.IsPrimaryNetwork() {
		if nSyncs.syncClusterRouterPort && oc.usesTransitRouter() {
...
func (oc *SecondaryLayer2NetworkController) addSwitchPortForRemoteNodeGR(node *corev1.Node) error {
...
// TODO this SNAT change requires cleanup
func (oc *SecondaryLayer2NetworkController) addOrUpdateUDNClusterSubnetEgressSNAT(localPodSubnets []*net.IPNet,
...
func (oc *SecondaryLayer2NetworkController) usesTransitRouter() bool {
	return oc.GetNetInfo().TopologyVariant() == types.Layer2RouterTopology
}
