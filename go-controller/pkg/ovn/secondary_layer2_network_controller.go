...
func (oc *SecondaryLayer2NetworkController) Cleanup() error {
	...
	ops, err := libovsdbops.DeleteLogicalRoutersWithPredicateOps(oc.nbClient, nil,
		func(item *nbdb.LogicalRouter) bool {
			return item.ExternalIDs[types.NetworkExternalID] == oc.GetNetworkName()
		})
	if err != nil {
...
func (oc *SecondaryLayer2NetworkController) addUpdateLocalNodeEvent(node *corev1.Node, nSyncs *nodeSyncs) error {
	...
	if util.IsNetworkSegmentationSupportEnabled() && oc.IsPrimaryNetwork() {
		if nSyncs.syncClusterRouterPort {
			if err = oc.syncClusterRouterPort(node, hostSubnets); err != nil {
...
func (oc *SecondaryLayer2NetworkController) addUpdateRemoteNodeEvent(node *corev1.Node, syncZoneIC bool) error {
	...
	if util.IsNetworkSegmentationSupportEnabled() && oc.IsPrimaryNetwork() {
		if syncZoneIC && config.OVNKubernetesFeature.EnableInterconnect {
			if err := oc.ensureRemoteNodeResources(node); err != nil {
...
func (oc *SecondaryLayer2NetworkController) ensureRemoteNodeResources(node *corev1.Node) error {
...
func (oc *SecondaryLayer2NetworkController) addUDNClusterSubnetEgressSNAT(localPodSubnets []*net.IPNet, routerName string) error {
	outputPort := types.RouterToSwitchPrefix + oc.GetNetworkScopedSwitchName("")
...
func (oc *SecondaryLayer2NetworkController) newTransitRouter() (*nbdb.LogicalRouter, error) {
	return oc.gatewayTopologyFactory.NewTransitRouter(
		oc.GetNetInfo(),
		oc.defaultCOPPUUID, strconv.Itoa(16477215+oc.GetNetworkID()),
	)
}
...
func (oc *SecondaryLayer2NetworkController) syncClusterRouterPort(node *corev1.Node, hostSubnets []*net.IPNet) error {
