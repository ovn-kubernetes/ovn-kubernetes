...
func NewSecondaryLayer2NetworkController(cnci *CommonNetworkControllerInfo, netInfo util.NetInfo, networkManager nad.NetworkManager) (*SecondaryLayer2NetworkController, error) {
