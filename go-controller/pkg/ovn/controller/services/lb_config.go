...
func makeNodeRouterTargetIPs(node *nodeInfo, c *lbConfig, hostMasqueradeIPV4, hostMasqueradeIPV6 string) (targetIPsV4, targetIPsV6 []string, v4Changed, v6Changed bool) {
	...
	hostMasqueradeIPsV4 := node.l3gatewayAddressesStr()
	hostMasqueradeIPsV6 := node.l3gatewayAddressesStr()

	if config.OvnKubeNode.Mode == types.NodeModeDPU {
		// hairpin traffic of the hostaddress in case of the DPU
		hostMasqueradeIPsV4 = node.hostAddressesStr()
		hostMasqueradeIPsV6 = node.hostAddressesStr()
	}

	targetIPsV4, v4Updated = util.UpdateIPsSlice(targetIPsV4, hostMasqueradeIPsV4, []string{hostMasqueradeIPV4})
	targetIPsV6, v6Updated = util.UpdateIPsSlice(targetIPsV6, hostMasqueradeIPsV6, []string{hostMasqueradeIPV6})
