...
var (
	nqosCount = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			Help:      "The total number of NetworkQoSes in the cluster",
		},
		[]string{"network"},
	)
	...
	nqosOvnOperationDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			...
			Help:      "Time spent on performing an OVN operation for NetworkQoSes",
	...
	nqosReconcileDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Namespace: types.MetricOvnkubeNamespace,
			Subsystem: types.MetricOvnkubeSubsystemController,
			Name:      "nqos_reconcile_duration_ms",
	...
	nqosPodReconcileDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Namespace: types.MetricOvnkubeNamespace,
			Subsystem: types.MetricOvnkubeSubsystemController,
			Name:      "nqos_pod_reconcile_duration_ms",
			Help:      "Time spent on reconciling a Pod change for NetworkQoSes",
			Buckets:   prometheus.ExponentialBuckets(.1, 2, 15),
		},
		[]string{"network"},
	)
	...
	nqosNamespaceReconcileDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			...
			Help:      "Time spent on reconciling Namespace change which affects Pods selection or egress selection for the NetworkQoSes",
			Buckets:   prometheus.ExponentialBuckets(.1, 2, 15),
		},
		[]string{"network"},
	)
