...
func (bnc *BaseNetworkController) addHairpinAllowACL() error {
	...
	ingressACL := libovsdbutil.BuildDefaultTierACL(ingressACLIDs, types.DefaultAllowPriority, match,
	...
	egressACL := libovsdbutil.BuildDefaultTierACL(egressACLIDs, types.DefaultAllowPriority, match,
...
func (bnc *BaseNetworkController) addAllowACLFromNode(switchName string, mgmtPortIP net.IP) error {
	...
	nodeACL := libovsdbutil.BuildDefaultTierACL(dbIDs, types.DefaultAllowPriority, match,
		nbdb.ACLActionAllowRelated, nil, libovsdbutil.LportIngress)
...
func (bnc *BaseNetworkController) buildDenyACLs(namespace, pgName string, aclLogging *libovsdbutil.ACLLoggingLevels,
	...
	denyACL = libovsdbutil.BuildDefaultTierACL(bnc.getDefaultDenyPolicyACLIDs(namespace, aclDir, defaultDenyACL),
		types.DefaultDenyPriority, denyMatch, nbdb.ACLActionDrop, aclLogging, aclPipeline)
	allowACL = libovsdbutil.BuildDefaultTierACL(bnc.getDefaultDenyPolicyACLIDs(namespace, aclDir, arpAllowACL),
