...
func initClusterCIDRAddressSet(
	...
	if netInfo.GetNetworkTransport() != types.NetworkTransportNoOverlay {
...
func getClusterCIDRAsUUID(
	...
	if netInfo.GetNetworkTransport() != types.NetworkTransportNoOverlay || netInfo.GetOutboundSNAT() != config.NoOverlaySNATEnabled {
		return "", "", nil
	}
