...
func (em *userDefinedNetworkExpectationMachine) expectedLogicalSwitchesAndPorts(isPrimary bool, localNode string) []libovsdbtest.TestData {
	return em.expectedLogicalSwitchesAndPortsWithLspEnabled(isPrimary, localNode, nil)
}

func (em *userDefinedNetworkExpectationMachine) expectedLogicalSwitchesAndPortsWithLspEnabled(isPrimary bool, localNode string, expectedPodLspEnabled map[string]*bool) []libovsdbtest.TestData {
