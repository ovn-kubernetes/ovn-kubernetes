...
func EnsureLocalZonePodAddressesToNodeRoute(watchFactory *factory.WatchFactory, nbClient libovsdbclient.Client,
	...
	if config.OVNKubernetesFeature.EnableInterconnect {
		...
		if err := libovsdbutil.CreateDefaultRouteToExternal(nbClient, types.OVNClusterRouter, types.GWRouterToJoinSwitchPrefix+types.GWRouterPrefix+pod.Spec.NodeName, clusterSubnets); err != nil {
			return err
		}
	}
