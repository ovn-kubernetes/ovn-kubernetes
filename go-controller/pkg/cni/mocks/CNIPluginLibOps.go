...
// AddRoute provides a mock function with given fields: ipn, gw, dev, mtu, priority
func (_m *CNIPluginLibOps) AddRoute(ipn *net.IPNet, gw net.IP, dev netlink.Link, mtu int, priority int) error {
	ret := _m.Called(ipn, gw, dev, mtu, priority)
