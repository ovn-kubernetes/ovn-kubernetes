...
OFPT_GET_CONFIG_REPLY (xid=0x4): frags=normal miss_send_len=0`
		...
		fmt.Println("================================================")
		fmt.Println("akaris", service)
		fmt.Println("akaris", endpointSlice)
		fmt.Println("akaris", endpointSlice2)
		fmt.Println("================================================")
	...
	Context("Setting up the gateway bridge", func() {
		...
		ovntest.OnSupportedPlatformsIt("sets up a shared interface gateway where ETP=local, SGW mode, with mixed "+
			...
			shareGatewayInterfaceTestETPLocalSGWMixedNamedPortsWithHostNetworkedPodsExtIP(
				app, testNS, eth0Name, eth0MAC, eth0GWIP, eth0CIDR, 0, link, false, true)
		})
