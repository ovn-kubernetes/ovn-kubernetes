...
add set inet ovn-kubernetes mgmtport-snat-pod-to-nodeports-v4 { type ipv4_addr . inet_proto . inet_service ; comment "Pod to NodePorts are subject to management port SNAT (IPv4)" ; }
add set inet ovn-kubernetes mgmtport-snat-pod-to-nodeports-v6 { type ipv6_addr . inet_proto . inet_service ; comment "Pod to NodePorts are subject to management port SNAT (IPv6)" ; }
