...
func (g *gateway) Reconcile() error {
	...
	if err := g.openflowManager.updateBridgeFlowCache(subnets, g.nodeIPManager.ListNetworkAddresses(),
		g.nodeIPManager.ListAddresses(), g.isPodNetworkAdvertised); err != nil {
		return err
	}
