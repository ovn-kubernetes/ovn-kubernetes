...
import (
	...
	virtualprivatenetworkconnectv1 "github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/virtualprivatenetworkconnect/v1/apis/informers/externalversions/virtualprivatenetworkconnect/v1"
)
...
// VirtualPrivateNetworkConnectInformer provides a mock function with no fields
func (_m *NodeWatchFactory) VirtualPrivateNetworkConnectInformer() virtualprivatenetworkconnectv1.VirtualPrivateNetworkConnectInformer {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for VirtualPrivateNetworkConnectInformer")
	}

	var r0 virtualprivatenetworkconnectv1.VirtualPrivateNetworkConnectInformer
	if rf, ok := ret.Get(0).(func() virtualprivatenetworkconnectv1.VirtualPrivateNetworkConnectInformer); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(virtualprivatenetworkconnectv1.VirtualPrivateNetworkConnectInformer)
		}
	}
