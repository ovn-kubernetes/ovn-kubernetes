...
func TestController_reconcile(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "should fail to reconcile two RouteAdvertisements selecting the same network and VRF",
			...
			reconcile:            "ra1",
			expectAcceptedStatus: metav1.ConditionFalse,
			expectAcceptedMsg:    "configuration error: overlapping CIDR detected between RouteAdvertisements \"ra1\" and \"ra2\" in VRF \"\": [30.1.0.0/16 30.1.0.0/16]", // Current behavior - both detect same subnets as overlapping
		},
	}
