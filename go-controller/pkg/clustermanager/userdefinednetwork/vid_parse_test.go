...
var _ = Describe("parseEVPNVIDs", func() {
	...
	DescribeTable("should handle various configs",
		...
		// Unicode escape edge cases - ensures we don't skip configs with \u escapes
		Entry("EVPN with unicode-escaped transport (e as \\u0065)", `{"transport":"\u0065vpn","evpnConfig":{"macVRF":{"vid":50}}}`, 50, 0, false),
		Entry("EVPN with fully unicode-escaped transport", `{"transport":"\u0065\u0076\u0070\u006e","evpnConfig":{"ipVRF":{"vid":60}}}`, 0, 60, false),
