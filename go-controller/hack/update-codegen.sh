...
echo "Copying virtualPrivateNetworkConnect CRD"
cp _output/crds/k8s.ovn.org_virtualprivatenetworkconnects.yaml ../dist/templates/k8s.ovn.org_virtualprivatenetworkconnects.yaml.j2
