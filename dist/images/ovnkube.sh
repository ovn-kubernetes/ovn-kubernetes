...
#OVN_CUSTOM_NET_CONF_ENABLE - enable connecting workloads with custom network configuration to UDNs
ovn_custom_net_conf_enable=${OVN_CUSTOM_NET_CONF_ENABLE:=false}
...
ovn-master() {
  ...
  ovn_custom_net_conf_enable_flag=
  if [[ ${ovn_custom_net_conf_enable} == "true" ]]; then
	  ovn_custom_net_conf_enable_flag="--enable-custom-network-configuration"
  fi
  echo "ovn_custom_net_conf_enable_flag=${ovn_custom_net_conf_enable_flag}"
