...
while [ "$1" != "" ]; do
  ...
  --network-segmentation-enable)
    ...
    ;;
  --custom-net-conf-enable)
    OVN_CUSTOM_NET_CONF_ENABLE=$VALUE
    ;;
...
ovn_custom_net_conf_enable=${OVN_CUSTOM_NET_CONF_ENABLE}
echo "ovn_custom_net_conf_enable: ${ovn_custom_net_conf_enable}"
