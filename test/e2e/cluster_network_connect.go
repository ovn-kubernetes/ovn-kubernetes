...
// The "full matrix (2x each type) - has all 8 networks in subnet annotation" test is the
// template for the CIDR style used here.
func newTestNetworkSubnetsAllocator() func() (string, string) {
	i := 0
	return func() (string, string) {
		i++
		// 172.31.0.0/16, 172.32.0.0/16, ... (non-overlapping /16s)
		v4 := fmt.Sprintf("172.%d.0.0/16", 30+i)
		// 2014:100:100::0/60, 2014:100:200::0/60, ... (non-overlapping /60s)
		v6 := fmt.Sprintf("2014:100:%d::0/60", i*100)
		return v4, v6
	}
}
...
var _ = Describe("ClusterNetworkConnect ClusterManagerController", feature.NetworkConnect, func() {
	...
	Context("when networks exist before CNC creation", func() {
		...
		DescribeTable("multiple networks (2xL3 + 2xL2): has all networks in subnet annotation",
			func(kind string) {
				...
				if kind == "UDN" {
					...
					createPrimaryCUDNWithSubnets(cs, networkNames[0], "Layer3", testLabel, "172.31.0.0/16", "2014:100:100::0/60", namespaces[0].Name)
					expectedTopologies = append(expectedTopologies, "Layer3")
					createPrimaryCUDNWithSubnets(cs, networkNames[1], "Layer3", testLabel, "172.32.0.0/16", "2014:100:200::0/60", namespaces[1].Name, namespaces[4].Name) // multi-ns
					expectedTopologies = append(expectedTopologies, "Layer3")
					createPrimaryCUDNWithSubnets(cs, networkNames[2], "Layer2", testLabel, "172.33.0.0/16", "2014:100:300::0/60", namespaces[2].Name)
					expectedTopologies = append(expectedTopologies, "Layer2")
					createPrimaryCUDNWithSubnets(cs, networkNames[3], "Layer2", testLabel, "172.34.0.0/16", "2014:100:400::0/60", namespaces[3].Name)
					expectedTopologies = append(expectedTopologies, "Layer2")
		...
		It("full matrix (2x each type) - has all 8 networks in subnet annotation", func() {
			...
			createLayer3PrimaryCUDNWithSubnets(cs, cudnNames[0], cudnLabel, "172.31.0.0/16", "2014:100:100::0/60", cudnNamespaces[0].Name)
			expectedTopologies = append(expectedTopologies, "Layer3")
			createLayer3PrimaryCUDNWithSubnets(cs, cudnNames[1], cudnLabel, "172.32.0.0/16", "2014:100:200::0/60", cudnNamespaces[1].Name)
			expectedTopologies = append(expectedTopologies, "Layer3")
			createLayer2PrimaryCUDNWithSubnets(cs, cudnNames[2], cudnLabel, "172.33.0.0/16", "2014:100:300::0/60", cudnNamespaces[2].Name)
			expectedTopologies = append(expectedTopologies, "Layer2")
			createLayer2PrimaryCUDNWithSubnets(cs, cudnNames[3], cudnLabel, "172.34.0.0/16", "2014:100:400::0/60", cudnNamespaces[3].Name)
			expectedTopologies = append(expectedTopologies, "Layer2")

			By("creating 4 UDNs (2xL3 + 2xL2)")
			createLayer3PrimaryUDNWithSubnets(cs, udnNamespaces[0].Name, "172.35.0.0/16", "2014:100:500::0/60", udnNames[0])
			expectedTopologies = append(expectedTopologies, "Layer3")
			createLayer3PrimaryUDNWithSubnets(cs, udnNamespaces[1].Name, "172.36.0.0/16", "2014:100:600::0/60", udnNames[1])
			expectedTopologies = append(expectedTopologies, "Layer3")
			createLayer2PrimaryUDNWithSubnets(cs, udnNamespaces[2].Name, "172.37.0.0/16", "2014:100:700::0/60", udnNames[2])
			expectedTopologies = append(expectedTopologies, "Layer2")
			createLayer2PrimaryUDNWithSubnets(cs, udnNamespaces[3].Name, "172.38.0.0/16", "2014:100:800::0/60", udnNames[3])
			expectedTopologies = append(expectedTopologies, "Layer2")
