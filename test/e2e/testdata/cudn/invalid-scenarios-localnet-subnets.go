...
spec:
  ...
  network:
    ...
    localnet:
      ...
      ipam: {mode: Disabled}
`,
		ExpectedErr: `The ClusterUserDefinedNetwork "localnet-ipam-disabled-and-excludesubnets-set-fail" is invalid: spec.network.localnet: Invalid value: "object": excludeSubnets must be unset when subents is unset`,
	},
	{
		Manifest: `
apiVersion: k8s.ovn.org/v1
