			...
			func(createNetworkFn func(c networkAttachmentConfigParams) error) {
				DescribeTable(
					...
					func(
						...
						deployment := e2edeployment.NewDeployment("test-deployment", replicas, map[string]string{"app": "test"}, "agnhost", images.AgnHost().PullSpec, appsv1.RollingUpdateDeploymentStrategyType)
