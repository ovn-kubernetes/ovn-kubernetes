...
`)
					...
					setSVCRouteOnExternalContainer(provider.ExternalContainer{Name: net.containerName},
				...
				for _, net := range []*netSettings{net1, net2} {
					for i, pod := range net.createdPods {
						...
						gomega.Eventually(func() error {
							return curlAgnHostClientIPFromPod(f.Namespace.Name, pod, expected, dst, externalContainer.GetPortStr())
						...
						gomega.Consistently(func() error {
							return curlAgnHostHostnameFromPod(f.Namespace.Name, pod, net.containerName, dst, externalContainer.GetPortStr())
...
func setSVCRouteOnExternalContainer(container provider.ExternalContainer, svcIP, v4Via, v6Via string) {
