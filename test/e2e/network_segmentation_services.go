...
func checkConnectionToLoadBalancersFromExternalContainer(f *framework.Framework, externalContainer provider.ExternalContainer, service *v1.Service, expectedOutput string) {
	GinkgoHelper()
	port := service.Spec.Ports[0].Port
