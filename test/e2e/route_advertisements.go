...
var _ = ginkgo.Describe("BGP: When default podNetwork is advertised", feature.RouteAdvertisements, func() {
	...
	ginkgo.When("no-overlay mode is enabled", func() {
		...
		ginkgo.It("should reconcile RA CR if manually deleted in managed mode", ginkgo.Serial, func() {
			...
			ginkgo.By("Waiting a bit for BGP routes to converge after RA recreation")
