...
addresses           : ["103.103.0.0/16", "104.104.0.0/16", "105.105.0.0/26"]
external_ids        : {}
...
1) It is responsible to allocate a /31 range for each node-network pair:
  ...
  * These values are annotated on the `ClusterNetworkConnect`
    ...
    k8s.ovn.org/node-network-subnets: {
      L3Network1Node1: 192.168.0.0/31,
      L3Network1Node2: 192.168.0.2/31,
      L3Network1Node3: 192.168.0.4/31,
      L3Network2Node1: 192.168.0.6/31,
      L3Network2Node2: 192.168.0.8/31,
      L3Network2Node3: 192.168.0.10/31,
      L2Network1: 192.168.0.12/31,
      L2Network2: 192.168.0.14/31,
      ...
    }
    ```
