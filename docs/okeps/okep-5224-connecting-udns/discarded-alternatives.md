...
However this would cause an assymmetry for reply traffic:

![blue-green-yellow-l3-connect-idea1-assymmetry](images/l3-idea1-assymmetry.png)
...
its the solution with no assymmetry. See the proposal for more
details around this.
