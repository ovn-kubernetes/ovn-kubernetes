...
Traced event-driven reconcile invocations start a new root span. Retries and later updates on the
same Pod may start new root spans and may link to the then-current annotation value. Startup sync
