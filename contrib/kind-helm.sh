...
usage() {
    ...
    echo "-ule | --uplink-enable                        Enable Uplink CRD support (requires network segmentation). DEFAULT: Disabled"
    ...
    while [ "$1" != "" ]; do
        case $1 in
            ...
            -nce | --network-connect-enable )     ENABLE_NETWORK_CONNECT=true
                                                  ;;
            -ule | --uplink-enable )              ENABLE_UPLINK=true
                                                  ;;
